...
#
#     title_matches_fragments, matches_found_title = check_title_match(title, fragments, threshold=2)
...
#
#     if artist_matches_fragments:
#         matches_found = 0
#         if matches_found_title > matches_found_artist:
#             matches_found = matches_found_title
#         else:
#             matches_found = matches_found_artist
#         return (title_matches_fragments and artist_matches_fragments), matches_found
#     elif album_matches_fragments:
#         matches_found = 0
#         if matches_found_title > matches_found_album:
#             matches_found = matches_found_title
#         else:
#             matches_found = matches_found_album
#         return (title_matches_fragments and album_matches_fragments), matches_found
#     else:
#         return False, 0
